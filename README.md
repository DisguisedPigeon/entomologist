...
- [x] [Exception tagging on the frontend](https://github.com/DisguisedPigeon/entomologist/issues/4)
- [x] [DB exporting and imporing](https://github.com/DisguisedPigeon/entomologist/issues/5)
- [x] [Backend filtering and handling](https://github.com/DisguisedPigeon/entomologist/issues/7)
- [x] [Frontend filtering and handling](https://github.com/DisguisedPigeon/entomologist/issues/6)
- [x] [UPDATE README AS THINGS CHANGE](https://github.com/DisguisedPigeon/entomologist/issues/8) - this is important
...
```gleam
let assert Ok(Nil) = entomologist.configure(connection) as "Entomologist has failed its configuration"
```
...
For more ergonomic interactions, checkout [entomologist_extensions](https://www.github.com/DisguisedPigeon/entomologist-extensions)
